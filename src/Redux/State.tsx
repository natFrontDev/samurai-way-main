...
export type AppPropsType = {
    dialogPage: {dialogData:Array <DialogPropsType>, messageData:Array<MessagePropsType>, newMessageText: string },
    profilePage: {postData: Array<PostPropsType>,  newPostText: string}
...
export type ActionDispatchTypes = addTextType | addPostType | updateNewMessageTextType | updateNewPostTextType
 ...
 export const store: StorePropsType = {
    ...
    subscribe(observer) {
        this._onChange = observer //RerenderTree=observer
    },
